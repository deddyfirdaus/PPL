...
public class framepilih extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        b_mulaibaru.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/mainmenu/new game1.png"))); // NOI18N
        b_mulaibaru.setBorderPainted(false);
        b_mulaibaru.setContentAreaFilled(false);
        b_mulaibaru.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/mainmenu/new game.png"))); // NOI18N
        getContentPane().add(b_mulaibaru, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 30, 210, 50));

        b_lanjut.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/mainmenu/continue1.png"))); // NOI18N
        b_lanjut.setToolTipText("");
        b_lanjut.setBorderPainted(false);
        b_lanjut.setContentAreaFilled(false);
        b_lanjut.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/mainmenu/continue.png"))); // NOI18N
        getContentPane().add(b_lanjut, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 120, 140, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/mainmenu/play.png"))); // NOI18N
